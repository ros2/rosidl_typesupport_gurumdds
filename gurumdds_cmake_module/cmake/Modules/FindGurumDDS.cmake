...
# - GurumDDS_INCLUDE_DIR: Paths to the header files
# - GurumDDS_LIBRARIES: Name to the C++ library including the path
# - GurumDDS_LIBRARY_DIRS: Path to the library
...
if(NOT _GURUMDDS_HOME STREQUAL "")
  ...
  set(GurumDDS_LIBRARIES "${GurumDDS_LIBRARY_DIRS}libdds.so")
  ...
  if(WIN32)
    # TODO(clemjh): GurumIDL support for Windows
  else()
