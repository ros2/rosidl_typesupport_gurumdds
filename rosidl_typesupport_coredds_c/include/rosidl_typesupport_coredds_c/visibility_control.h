...
//     https://gcc.gnu.org/wiki/Visibility
  ...
  #else
    #define ROSIDL_TYPESUPPORT_COREDDS_C_EXPORT __declspec(dllexport)
    #define ROSIDL_TYPESUPPORT_COREDDS_C_IMPORT __declspec(dllimport)
  #endif
  #ifdef ROSIDL_TYPESUPPORT_COREDDS_C_BUILDING_DLL
  ...
  #define ROSIDL_TYPESUPPORT_COREDDS_C_IMPORT
  #if __GNUC__ >= 4
