...
def generate_typesupport_coredds_c(args):
    template_dir = args['template_dir']
    mapping_msgs = {
        os.path.join(template_dir, 'msg__rosidl_typesupport_coredds_c.h.em'):
        ...
        if extension == '.msg':
            ...
            for template_file, generated_filename in mapping_msgs.items():
                ...
                if generated_filename.endswith('.cpp'):
                    generated_file = os.path.join(generated_file, 'dds_coredds_c')
