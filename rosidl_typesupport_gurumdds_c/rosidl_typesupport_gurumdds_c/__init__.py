...
def generate_typesupport_gurumdds_c(args):
    template_dir = args['template_dir']
    mapping_msgs = {
        os.path.join(template_dir, 'msg__rosidl_typesupport_gurumdds_c.h.em'):
    ...
    mapping_srvs = {
        os.path.join(template_dir, 'srv__rosidl_typesupport_gurumdds_c.h.em'):
        '%s__rosidl_typesupport_gurumdds_c.h',
    ...
    # generate_dds_gurumdds_cpp() and therefore the make target depend on the additional files
        ...
        if extension == '.msg':
            ...
            for template_file, generated_filename in mapping_msgs.items():
                ...
                if generated_filename.endswith('.cpp'):
                    generated_file = os.path.join(generated_file, 'dds_gurumdds_c')
