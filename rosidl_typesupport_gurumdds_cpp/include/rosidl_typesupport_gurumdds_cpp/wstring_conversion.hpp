...
#ifndef ROSIDL_TYPESUPPORT_GURUMDDS_CPP__WSTRING_CONVERSION_HPP_
#define ROSIDL_TYPESUPPORT_GURUMDDS_CPP__WSTRING_CONVERSION_HPP_
...
bool convert_wstring_to_u16string(
  const dds_Wstring wstr, std::u16string & u16str);

}  // namespace rosidl_typesupport_gurumdds_cpp

#endif  // ROSIDL_TYPESUPPORT_GURUMDDS_CPP__WSTRING_CONVERSION_HPP_
