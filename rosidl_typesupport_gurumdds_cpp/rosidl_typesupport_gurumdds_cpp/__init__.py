...
def generate_cpp(args, message_specs, service_specs, known_msg_types):
    ...
    mapping_msgs = {
        os.path.join(template_dir, 'msg__rosidl_typesupport_gurumdds_cpp.hpp.em'):
        '%s__rosidl_typesupport_gurumdds_cpp.hpp',
        os.path.join(template_dir, 'msg__type_support.cpp.em'):
        '%s__type_support.cpp',
    }
    mapping_srvs = {
        os.path.join(template_dir, 'srv__rosidl_typesupport_gurumdds_cpp.hpp.em'):
        '%s__rosidl_typesupport_gurumdds_cpp.hpp',
    ...
    for idl_file, spec in message_specs:
        ...
        for template_file, generated_filename in mapping_msgs.items():
            ...
            if generated_filename.endswith('.cpp') or generated_filename.endswith('.c'):
                generated_file = os.path.join(generated_file, 'dds_gurumdds')
