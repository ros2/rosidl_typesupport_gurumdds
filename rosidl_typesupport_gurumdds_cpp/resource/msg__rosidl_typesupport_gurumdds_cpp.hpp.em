// generated from
// rosidl_typesupport_gurumdds_cpp/resource/msg__rosidl_typesupport_gurumdds_cpp.hpp.em
// generated code does not contain a copyright notice

@#######################################################################
@# EmPy template for generating
@# <msg>__rosidl_typesupport_gurumdds_cpp.hpp files
@#
@# Context:
...
header_guard_parts = [
    ...
    get_header_filename_from_msg_name(spec.base_type.type) + '__rosidl_typesupport_gurumdds_cpp_hpp']
...
#include "@(spec.base_type.pkg_name)/msg/rosidl_typesupport_gurumdds_cpp__visibility_control.h"
...
#include "@(field.type.pkg_name)/msg/dds_gurumdds/include/@(field.type.pkg_name)/msg/dds_/@(field.type.type)_TypeSupport.h"
#include "@(field.type.pkg_name)/msg/dds_gurumdds/include/@(field.type.pkg_name)/msg/dds_/@(field.type.type)_.h"
@[  end if]@
@[end for]@
