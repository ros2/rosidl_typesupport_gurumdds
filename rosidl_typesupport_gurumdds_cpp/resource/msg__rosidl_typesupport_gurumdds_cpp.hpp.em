...
dds_specific_header_files.append(type_.namespaces[0] + '/' + type_.namespaces[1] + '/dds_gurumdds/include/' + type_.namespaces[0] + '/' + type_.namespaces[1] + '/dds_/' + type_.name + '_TypeSupport.h')
dds_specific_header_files.append(type_.namespaces[0] + '/' + type_.namespaces[1] + '/dds_gurumdds/include/' + type_.namespaces[0] + '/' + type_.namespaces[1] + '/dds_/' + type_.name + '_.h')
}@
@[  end if]@
@[end for]@
